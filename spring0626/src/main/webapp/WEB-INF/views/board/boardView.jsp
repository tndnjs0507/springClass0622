...
<section>
    ...
    <table>
      ...
      <tr>
      	<td colspan="3" class="article"><strong>다음글</strong> <span class="separator">|</span>${bdto.bfile }</td>
      </tr>
      <tr>
      	<td colspan="3">
      ...
      <tr>
        <td colspan="3"><strong>이전글</strong> <span class="separator">|</span>${prevDto.btitle}</td>
      </tr>
    </table>
